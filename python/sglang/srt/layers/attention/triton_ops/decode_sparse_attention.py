...
def _fwd_kernel_stage1(
    ...
    sliding_tokens_per_split = tl.cdiv(sliding_window_size, NUM_SLIDING_KV_SPLITS)
...
def test_correctness():
    ...
    from sglang.srt.layers.attention.triton_ops.debug_temp import block_sparse_attention as block_sparse_attention_debug
    args = torch.load("../bsa_params.pth")
    ...
    gt_output_2, attn_logits_2 = block_sparse_attention_debug(
        args['q'], args['k'], args['v'],
        args['seq_lens'],
        args['indices'],
        args['ks'],
    ...
    print('gt context diff', (gt_output_2 - gt_output).abs().mean() / gt_output.abs().mean())
    output, attn_logits = decode_block_sparse_attention(
        args['q'], args['k'], args['v'],
        args['seq_lens'],
        args['indices'],
        args['ks'],
    ...
    print('context diff', (output - gt_output_2).abs().mean() / gt_output_2.abs().mean())
